...
is_taken(Class, X) :- taken(X)=Class.

available([]).
available([H|T]) :- not is_taken(H, X), available(T).

/* [ [mon,12,r1], [mon,1,r1], [mon,1,r4] ] */
in_conflict([H1|T1], List ) :- my_member(H1, List).
in_conflict( [H1|T1] , List ):- in_conflict(T1,List).

day_time_member( [D,T,R1], [ [D,T,R2] | Tail]).
...
class_time( [Day,Hour,Room] ):-
	my_member(Day, [mon,tue,wed,thu,fri] ),
	my_member(Hour, [9,10,11,12,1,2,3,4] ),
	my_member(Room, [r1,r2,r3,r4] ).
...
print_solution( [AI1,AI2,AI3,AI4,OS1,OS2,OS3,WD1,WD2,WD3,DS1,DS2,DS3,AL1,AL2,AL3,NE1,NE2] ):-
	...
	not in_conflict([AI1,AI2,AI3,AI4],[OS1,OS2,OS3]),
	...
	not in_conflict([AI1,AI2,AI3,AI4,OS1,OS2,OS3],[NE1,NE2]),
	not prof_conflict( [OS1,OS2,OS3], [NE1,NE2] ),
	...
	not in_conflict([AI1,AI2,AI3,AI4,OS1,OS2,OS3,NE1,NE2],[WD1,WD2,WD3]),
	...
	not in_conflict([AI1,AI2,AI3,AI4,OS1,OS2,OS3,NE1,NE2,WD1,WD2,WD3],[DS1,DS2,DS3]),
	...
	not in_conflict([AI1,AI2,AI3,AI4,OS1,OS2,OS3,NE1,NE2,WD1,WD2,WD3,DS1,DS2,DS3],[AL1,AL2,AL3]),
